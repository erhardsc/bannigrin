...
$themify_theme_config['panel']['styling']['tab']['form_elements'] = array(
	...
	'element' => array(
		array(
			...
			'selector' => 'textarea, input[type=text], input[type=password], input[type=search], input[type=email], input[url]',
			'module' => array(
				'background-color',
				'border',
				'padding',
		...
		array(
			...
			'selector' => 'textarea:focus, input[type=text]:focus, input[type=password]:focus, input[type=search]:focus, input[type=email]:focus, input[url]:focus',
			'module' => array(
				'background-color',
				'border',
				'color'
