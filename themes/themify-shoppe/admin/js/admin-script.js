(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('#query-posts input[name="layout"],#query-products input[name="product_layout"]').change(function (e) {
            var $val = $(this).val(),
                    $post_type = $(this).parents('#query-posts').length > 0 ? '' : 'product_',
                    $media = $post_type == '' ? $('#media_position').closest('.themify_field_row') : $(),
                    $gutter = $post_type == '' ? $('#post_gutter') : $('#product_gutter'),
                    $gutter = $gutter.closest('.themify_field_row'),
        ...
        $('#query_category,#product_query_category').change(function () {
        ...
        $('#product_more_posts, #more_posts').change(function (e) {
            var $val = $(this).val(),
                    $post_type = $(this).parents('#query-posts').length > 0 ? '' : 'product_',
        ...
        $('input[name="header_wrap"]').change(function () {
        ...
        $('#exclude_cart .ddbtn a').click(function () {
