...
b.isotope("appended",e);b.hasClass("auto_tiles")&&a("body").hasClass("tile_enable")&&b.trigger("infiniteloaded.themify",[e]);a("#infscr-loading").fadeOut("normal");1===g&&a("#load-more, #infscr-loading").remove();a("body").trigger("infiniteloaded.themify",[e])});--g;1<g&&"auto"!==themifyScript.autoInfinite&&a(".load-more-button").show()});"auto"===themifyScript.autoInfinite&&a("#load-more, #load-more a").hide()}FixedHeader={headerHeight:0,hasHeaderSlider:!1,headerSlider:!1,init:function(){a("body").hasClass("fixed-header")&&
...
a(document).ready(function(b){function a(a){var c=b('<div class="post-tiled tiled-square-small" style="visibility: hidden !important; opacity: 0;" />').appendTo(a.first()),e=themifyScript.tiledata.padding,d=parseFloat(c.width());c.remove();a.each(function(){var a=b(this);b(this).imagesLoaded().always(function(b){a.children(".product").addClass("post");b=a.children(".post");themifyScript.tiledata.padding=a.hasClass("no-gutter")?0:e;a.themify_tiles(themifyScript.tiledata,d);setClasses(b,d)})})}function g(c){b(document).ajaxComplete(function(c,
e,d){"POST"===d.type&&d.url.indexOf("wpf_search")&&a(b(".loops-wrapper.auto_tiles"))})}var e=b("body");FixedHeader.init();b(".has-mega-sub-menu").length&&Themify.LoadAsync(themifyScript.theme_url+"/themify/megamenu/js/themify.mega-menu.js",null,null,null,function(){return"undefined"!==typeof b.fn.ThemifyMegaMenu});0<b(".loops-wrapper.masonry").length&&(b.fn.isotope?LayoutAndFilter.init():Themify.LoadAsync(themifyScript.theme_url+"/js/jquery.isotope.min.js",function(){LayoutAndFilter.init()},null,
null,function(){return"undefined"!==typeof b.fn.isotope}));0<b(".loops-wrapper.infinite").length&&(b.fn.infinitescroll?f(b(".loops-wrapper.infinite"),".loops-wrapper.infinite .post"):Themify.LoadAsync(themifyScript.theme_url+"/js/jquery.infinitescroll.min.js",function(){f(b(".loops-wrapper.infinite"),".loops-wrapper.infinite .post")},null,null,function(){return"undefined"!==typeof b.fn.infinitescroll}));var d=b(".auto_tiles");0<d.length&&e.hasClass("tile_enable")&&("undefined"===typeof Tiles?Themify.LoadAsync(themifyScript.theme_url+
"/js/tiles.min.js",function(){b.fn.themify_tiles?(a(d),g(d)):Themify.LoadAsync(themifyScript.theme_url+"/js/themify-tiles.js",function(){a(d);g(d)},null,null,function(){return"undefined"!==typeof b.fn.themify_tiles})},null,null,function(){return"undefined"!==typeof Tiles}):(a(d),g(d)));var k=b("#search-lightbox-wrap");if(0<k.length){var m=[],l,r=k.find("#searchform input"),h=k.find(".search-results-wrap");b(".search-button, #close-search-box").click(function(a){a.preventDefault();b(this).hasClass("search-button")?
(k.fadeIn(function(){r.focus();e.css("overflow-y","hidden")}),b("body").addClass("searchform-slidedown")):(l&&l.abort(),k.fadeOut(),e.css("overflow-y","visible"),b("body").removeClass("searchform-slidedown"))});h.delegate(".search-option-tab a","click",function(a){a.preventDefault();a=b(this).attr("href").replace("#","");"all"===a?a="item":h.find(".result-item").stop().fadeOut();0<b("#result-link-"+a).length&&(b(".view-all-button").hide(),b("#result-link-"+a).show());h.find(".result-"+a).stop().fadeIn();
b(this).closest("ul").children("li.active").removeClass("active");b(this).closest("li").addClass("active")});r.prop("autocomplete","off").keyup(function(a){function c(a){0>a&&(a=0);h.find(".search-option-tab li").eq(a).children("a").trigger("click");h.show()}if(48<=a.keyCode&&57>=a.keyCode||65<=a.keyCode&&90>=a.keyCode||8===a.keyCode){var d=b.trim(b(this).val());d?m[d]?(a=h.find(".search-option-tab li.active").index(),h.hide().html(m[d]),c(a)):setTimeout(function(){d=b.trim(r.val());l&&l.abort();
d?l=b.ajax({url:themifyScript.ajax_url,type:"POST",data:{action:"themify_search_autocomplete",term:d},beforeSend:function(){k.addClass("themify-loading");h.html('<span class="themify_spinner"></span>')},complete:function(){k.removeClass("themify-loading")},success:function(a){if(!d)h.html("");else if(a){var b=h.find(".search-option-tab li.active").index();h.hide().html(a);c(b);h.find(".search-option-tab li.active");m[d]=a}}}):h.html("")},100):h.html("")}})}b(".back-top a").click(function(){b("body,html").animate({scrollTop:0},
800);return!1});e.hasClass("touch")&&(b.fn.themifyDropdown?b("#main-nav").themifyDropdown():Themify.LoadAsync(themify_vars.url+"/js/themify.dropdown.js",function(){b("#main-nav").themifyDropdown()},null,null,function(){return"undefined"!==typeof b.fn.themifyDropdown}));e.hasClass("header-minbar-left")||e.hasClass("header-left-pane")||e.hasClass("header-slide-left")?b("#menu-icon").themifySideMenu({close:"#menu-icon-close",side:"left"}):b("#menu-icon").themifySideMenu({close:"#menu-icon-close"});if(e.hasClass("no-touch")){var q=
b(".top-icon-wrap #cart-list"),n=e.is(".header-minbar-left,.header-minbar-right,.header-overlay,.header-slide-right,.header-slide-left")?b("#mobile-menu"):e.is(".header-left-pane,.header-right-pane")?b("#headerwrap"):!1;(n&&0<n.length||0<q.length)&&Themify.LoadAsync(themifyScript.theme_url+"/js/jquery.nicescroll.min.js",function(){0<q.length&&(q.niceScroll(),setTimeout(function(){q.getNiceScroll().resize()},200));n&&(n.niceScroll(),e.on("sidemenushow.themify",function(){setTimeout(function(){n.getNiceScroll().resize()},
200)}))},null,null,function(){return"undefined"!==typeof b.fn.niceScroll})}var p=b('<div class="body-overlay">');e.append(p).on("sidemenushow.themify",function(){p.addClass("body-overlay-on")}).on("sidemenuhide.themify",function(){p.removeClass("body-overlay-on")}).on("click.themify touchend.themify",".body-overlay",function(){b("#menu-icon").themifySideMenu("hide");b("#cart-link").themifySideMenu("hide")});b(window).on("debouncedresize",function(){b("#menu-icon").is(":visible")&&b("#mobile-menu").hasClass("sidemenu-on")?
p.addClass("body-overlay-on"):p.removeClass("body-overlay-on")});b("#main-nav li.menu-item-has-children > a, #main-nav li.page_item_has_children > a").after("<span class='child-arrow'></span>");b("#main-nav li.menu-item-has-children > .child-arrow, #main-nav li.page_item_has_children > .child-arrow").click(function(){b(this).toggleClass("toggle-on");return!0});b("body").delegate("#themify_builder_lightbox_parent #layout_post a, #themify_builder_lightbox_parent #layout_products a","click",function(){var a=
b("#themify_builder_lightbox_parent .masonry_post"),d=b("#themify_builder_lightbox_parent .content_layout");b("#themify_builder_lightbox_parent .post_gutter");var c=b(this).prop("id");"grid3"===c||"grid2"===c||"grid4"===c?a.show():(a.hide(),"auto_tiles"===c?d.hide():d.show())});b("body").on("editing_module_option",function(a,c){0<b("#themify_builder_lightbox_parent .masonry_post").length&&setTimeout(function(){var a=0<b("#themify_builder_lightbox_parent #layout_post").length?"#layout_post":"#layout_products",
c=b("#themify_builder_lightbox_parent "+a+" a.selected");0===c.length&&(c=b("#themify_builder_lightbox_parent "+a+" a").first());c.trigger("click")},600)});if(e.hasClass("header-left-pane")||e.hasClass("header-right-pane")){var u=b(".top-icon-wrap, .search-button"),v=b("#mobile-menu");b(v).prepend(b('<div class="header-icons"></div>'));b(".header-icons").append(u)}});a(window).load(function(){"undefined"!==typeof ThemifyGallery&&ThemifyGallery.init({context:jQuery(themifyScript.lightboxContext)});
a(function(a){a("#main-nav li").on("mouseenter mouseleave",function(b){if(a("ul",this).length){var c=a("ul:first",this);b=c.offset().left;var c=c.width(),d=a(window).width();b+c<=d?a(this).removeClass("edge"):a(this).addClass("edge")}})})}).on("load debouncedresize ready",function(b){b=a(window).width();var c=a("body");if(c.hasClass("header-logo-center"))1183<b?(b=a(window).width()/2-a("#site-logo").width()/2,a("#main-nav").css("max-width",b)):a("#main-nav").removeAttr("style");else if(c.hasClass("header-slide-right")||
c.hasClass("header-slide-left")){var c=a(".top-icon-wrap, .search-button"),d=a("#mobile-menu"),e=a("#main-nav-wrap");1183<b?d.before(c):e.before(c)}});var d=function(){a(window).width()>tf_mobile_menu_trigger_point?a("#main-nav li.has-mega-column > ul, #main-nav li.has-mega-sub-menu > .mega-sub-menu").css("width",a("#header").width()):a("#main-nav li.has-mega-column > ul, #main-nav li.has-mega-sub-menu > .mega-sub-menu").removeAttr("style")};a(document).on("ready",d);a(window).on("debouncedresize",
d)})(jQuery);
