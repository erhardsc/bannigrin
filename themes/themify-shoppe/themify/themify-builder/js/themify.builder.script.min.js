...
" .carousel-pager",items:g});c.isBuilderActive()&&a.closest(".module-slider").find(".carousel-nav-wrap").remove();"no"==a.data("wrap")&&(f.circular=!1,f.infinite=!1);0<h?a.imagesLoaded().always(function(){c.carouselInitSwipe(a,f)}):c.carouselInitSwipe(a,f);b(".mejs__video").on("resize",function(b){b.stopPropagation()});var n=!1,p;b(d).resize(function(){n=!0;d.innerWidth<=tbLocalScript.breakpoints.mobile?(f.items.width=1,f.items.visible.max=a.data("visible-mobile")):(f.items.width=150,f.items.visible.max=
a.data("visible"));a.trigger("finish").trigger("configuration",f)});setInterval(function(){n&&(n=!1,clearTimeout(p),p=setTimeout(function(){b(".mejs__video").resize();a.trigger("updateSizes");"auto"==k&&"video"==a.data("type")&&ThemifyBuilderModuleJs.videoSliderAutoHeight(a)},100))},250)}}})},carouselInitSwipe:function(a,c){a.carouFredSel(c);a.swipe({excludedElements:"label, button, input, select, textarea, .noSwipe",swipeLeft:function(){a.trigger("next",!0)},swipeRight:function(){a.trigger("prev",
!0)},tap:function(a,c){b(c).parent().trigger("click")}})},loadOnAjax:function(b){var a=ThemifyBuilderModuleJs;""==tbLocalScript.fullwidth_support&&a.setupFullwidthRows();a.touchdropdown();a.tabs(b);a.carousel(b);a.charts(b);a.fullwidthVideo(b,!0);a.backgroundSlider()},rowCover:function(){b("body").on("mouseenter mouseleave",".themify_builder_row, .module_column, .module_subrow, .sub_column",function(a){var c=b(this).children(".builder_row_cover");if(0===c.length&&(c=b(this).children(".tb-column-inner, .ms-tableCell").first().children(".builder_row_cover"),
