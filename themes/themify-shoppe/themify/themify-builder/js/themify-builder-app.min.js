...
ThemifyBuilderCommon.Lightbox.setup();ThemifyBuilderCommon.LiteLightbox.modal.on("attach",function(){this.$el.addClass("themify_builder_lite_lightbox_modal")});e.Utils.setupTooltips();e.Utils.mediaUploader();e.Utils.openGallery();var a=function(a){b(a).find(".themify_builder_column_action").toggleClass("compact-mode",184>b(a).width())};b("body").on("mouseenter",".themify_builder_col",function(b){b.stopPropagation();a(this)});setTimeout(function(){b(".themify_builder_col").each(function(){a(this)})},
500)};e.Utils={clearClass:"col6-1 col5-1 col4-1 col4-2 col4-3 col3-1 col3-2 col2-1 col-full",gridClass:"col-full col4-1 col4-2 col4-3 col3-1 col3-2 col6-1 col5-1".split(" "),tfb_hidden_editor_object:null,_addNewColumn:function(a,b){var c=e.Views.init_column({grid_class:a.newclass,component_name:a.component},a.type);b.append(c.view.render().$el)},removeGridClass:function(a,b){b=b.split(",");for(var c=a.prop("class").replace(/ +(?= )/g,"").split(" "),e=0;e<c.length;e++)for(var g=0;g<b.length;g++)-1!==
c[e].indexOf(b[g])&&-1===c[e].indexOf("col-direction")&&a.removeClass(c[e])},removeEmptyFields:function(a){return a},hideResponsiveCols:function(a,c){if(c){c=parseInt(c);var d=0===c%2;a.hide().each(function(){var a=parseInt(b(this).children("a").data("col"));a===c||1===a||d&&0===c%a?b(this).show():!d&&c>a&&(5===c&&(2===a||3===a)||3===c&&2===a)&&b(this).show()});var e=a.first().closest(".themify_builder_grid_list_wrapper").find(".themify_builder_column_direction");1===c?e.hide():e.show()}},filterClass:function(a){var c=
this.gridClass.concat(["first","last"]);a=a.split(" ");for(var d=[],e=0;e<a.length;e++)-1<b.inArray(a[e],c)&&d.push(a[e]);return d.join(" ")},_getRowSettings:function(a,c){var d=this,f={},g={};a.find(".themify_builder_row_content").children(".themify_builder_col").each(function(a){var c=d.filterClass(b(this).attr("class")),f={};b(this).find(".themify_module_holder").first().children().each(function(a){if(b(this).hasClass("active_module")){var c=b(this).data("cid"),c=e.Models.Registry.lookup(c);f[a]=
{mod_name:c.get("mod_name"),mod_settings:c.get("mod_settings")}}b(this).hasClass("themify_builder_sub_row")&&(f[a]=d._getSubRowSettings(b(this),a))});g[a]={column_order:a,grid_class:c,modules:f};b(this).prop("style").width&&(g[a].grid_width=parseFloat(b(this).prop("style").width));0<b(this).children(".column-data-styling").length&&(c=b.parseJSON(b(this).children(".column-data-styling").attr("data-styling")),"object"===typeof c&&(g[a].styling=c))});f={row_order:c,cols:g};"gutter-default"!==a.data("gutter")&&
(f.gutter=a.data("gutter"));"col_align_top"!==a.data("column-alignment")&&(f.column_alignment=a.data("column-alignment"));"ltr"!==a.data("desktop_dir")&&(f.desktop_dir=a.data("desktop_dir"));"ltr"!==a.data("tablet_dir")&&(f.tablet_dir=a.data("tablet_dir"));"ltr"!==a.data("mobile_dir")&&(f.mobile_dir=a.data("mobile_dir"));"tablet-auto"!==b.trim(a.data("tablet"))&&(f.col_tablet=b.trim(a.data("tablet")));"mobile-auto"!==b.trim(a.data("mobile"))&&(f.col_mobile=b.trim(a.data("mobile")));if(0<a.find(".row-data-styling").length){var h=
b.parseJSON(a.find(".row-data-styling").attr("data-styling"));"object"===typeof h&&(f.styling=h)}return f},_getSubRowSettings:function(a,c){var d=this,f={},g={};a.find(".themify_builder_col").each(function(a){var c=d.filterClass(b(this).attr("class")),f={};b(this).find(".active_module").each(function(a){var c=b(this).data("cid"),c=e.Models.Registry.lookup(c);f[a]={mod_name:c.get("mod_name"),mod_settings:c.get("mod_settings")}});g[a]={column_order:a,grid_class:c,modules:f};b(this).prop("style").width&&
(g[a].grid_width=parseFloat(b(this).prop("style").width));0<b(this).children(".column-data-styling").length&&(c=b.parseJSON(b(this).children(".column-data-styling").attr("data-styling")),"object"===typeof c&&(g[a].styling=c))});f={row_order:c,cols:g};"gutter-default"!==a.data("gutter")&&(f.gutter=a.data("gutter"));"col_align_top"!==a.data("column-alignment")&&(f.column_alignment=a.data("column-alignment"));"ltr"!==a.data("desktop_dir")&&(f.desktop_dir=a.data("desktop_dir"));"ltr"!==a.data("tablet_dir")&&
(f.tablet_dir=a.data("tablet_dir"));"ltr"!==a.data("mobile_dir")&&(f.mobile_dir=a.data("mobile_dir"));"tablet-auto"!==b.trim(a.data("tablet"))&&(f.col_tablet=b.trim(a.data("tablet")));"mobile-auto"!==b.trim(a.data("mobile"))&&(f.col_mobile=b.trim(a.data("mobile")));if(0<a.find(".subrow-data-styling").length){var h=b.parseJSON(a.find(".subrow-data-styling").attr("data-styling"));"object"===typeof h&&(f.styling=h)}return f},builderPlupload:function(a){a=b(".themify-builder-plupload-upload-uic"+("new_elemn"===
a?".plupload-clone":""));if(0<a.length){var c=!1;a.each(function(){var a=b(this),e=a.attr("id").replace("themify-builder-plupload-upload-ui","");c=JSON.parse(JSON.stringify(themify_builder_plupload_init));c.browse_button=e+c.browse_button;c.container=e+c.container;c.drop_element=e+c.drop_element;c.file_data_name=e+c.file_data_name;c.multipart_params.imgid=e;c.multipart_params._ajax_nonce=themifyBuilder.tfb_load_nonce;c.multipart_params.topost=themifyBuilder.post_ID;a.data("extensions")&&(c.filters[0].extensions=
a.data("extensions"));e=new plupload.Uploader(c);e.bind("Init",function(a){});e.init();e.bind("FilesAdded",function(a,c){a.refresh();a.start();b("#themify_builder_alert").addClass("busy").show()});e.bind("Error",function(a,c){var d=b(".prompt-box .show-error");b(".prompt-box .show-login").hide();d.show();0<d.length&&d.html('<p class="prompt-error">'+c.message+"</p>");b(".overlay, .prompt-box").fadeIn(500)});e.bind("FileUploaded",function(c,d,e){c=JSON.parse(e.response);var f="200"!=e.status||c.error?
"error":"done";b("#themify_builder_alert").removeClass("busy").addClass(f).delay(800).fadeOut(800,function(){b(this).removeClass(f)});c.error?alert(c.error):(e=c.large_url?c.large_url:c.url,d=c.id,c=c.thumb,a.closest(".themify_builder_input").find(".themify-builder-uploader-input").val(e).trigger("change").parent().find(".img-placeholder").empty().html(b("<img/>",{src:c,width:50,height:50})).parent().show(),a.closest(".themify_builder_input").find(".themify-builder-uploader-input-attach-id").val(d))});
a.removeClass("plupload-clone")})}},columnDrag:function(a,c,d,f){c&&(a?a.children(".themify_builder_col").css("width",""):b(".themify_builder_col").css("width",""));var g=this;c=a?a.children(".themify_builder_col").find(".themify_grid_drag"):b(".themify_grid_drag");var h=c.first().closest("[data-postid]"),k={"col6-1":14,"col5-1":17.44,"col4-1":22.6,"col4-2":48.4,"col2-1":48.4,"col4-3":74.2,"col3-1":31.2,"col3-2":65.6},l={"col6-1":15.33,"col5-1":18.72,"col4-1":23.8,"col4-2":49.2,"col2-1":49.2,"col4-3":74.539,
"col3-1":32.266,"col3-2":66.05},t={"col6-1":16.666,"col5-1":20,"col4-1":25,"col4-2":50,"col2-1":50,"col4-3":75,"col3-1":33.333,"col3-2":66.666};if(d&&f){a=a.children(".themify_builder_col");var q=("gutter-narrow"===d?1.6:"gutter-none"===d?0:3.2)-("gutter-narrow"===f?1.6:"gutter-none"===f?0:3.2),q=parseFloat(q*(a.length-1)/a.length);a.each(function(a){b(this).prop("style").width&&(a=parseFloat(b(this).prop("style").width)+q,b(this).css("width",a+"%"))})}else c.each(function(){var a=b(this),c=a.closest(".themify_builder_sub_row_content"),
c=0===c.length?a.closest(".themify_builder_row_content"):c,d=c.children(".themify_builder_col"),f=a.closest(".themify_builder_col"),q=0,n=a.hasClass("themify_drag_right")?"w":"e",r=!1,A=0,B="w"===n?"themify_grid_drag_placeholder_right":"themify_grid_drag_placeholder_left",y,z,C,n=a.hasClass("themify_drag_right")?"w":"e";a.draggable({axis:"x",cursor:"col-resize",distance:0,containment:".themify_builder_row_content",helper:function(a){return b('<div class="ui-widget-header themify_grid_drag_placeholder '+
B+'"></div><div class="ui-widget-header themify_grid_drag_placeholder"></div>')},start:function(b,d){e.vent.trigger("dom:observer:start",h);z="rtl"===c.closest("[data-cid]").data(e.activeBreakPoint+"_dir");"w"===n?(r=z?f.prev(".themify_builder_col"):f.next(".themify_builder_col"),q=a.outerWidth()):(r=z?f.next(".themify_builder_col"):f.prev(".themify_builder_col"),q=f.outerWidth());A=r.outerWidth()-2;C=d.position.left;y=c.outerWidth()},stop:function(a,m){b(".themify_grid_drag_placeholder").remove();
e.vent.trigger("dom:observer:end",h);var q=Math.ceil(100*(f.outerWidth()/y));f.css("width",q+"%");var p=k,q=3.2;c.hasClass("gutter-narrow")?(p=l,q=1.6):c.hasClass("gutter-none")&&(p=t,q=0);var n=q*(d.length-1);d.each(function(a){a!==r.index()&&(b(this).prop("style").width?a=parseFloat(b(this).prop("style").width):(a=b.trim(g.filterClass(b(this).attr("class")).replace("first","").replace("last","")),a=p[a]),n+=a)});r.css("width",100-n+"%")},drag:function(a,b){if(r&&0<r.length){var c=q+("e"===n?-b.position.left:
b.position.left),d=parseFloat(100*c/y);if(5<=d&&100>d){var e=A+C+("w"===n?-b.position.left:b.position.left),g=parseFloat(100*e/y);5<g&&100>g&&(r.css("width",e+"px"),f.css("width",c+"px").children("."+B).html(d.toFixed(2)+"%"),f.children(".themify_grid_drag_placeholder").last().html(g.toFixed(2)+"%"))}}}})})},initNewEditor:function(a){if("undefined"!==typeof tinyMCEPreInit.mceInit[a])return this.initMCEv4(a,tinyMCEPreInit.mceInit[a]);var b=this.tfb_hidden_editor_object;b.elements=a;b.selector="#"+
...
this.clearClass.split(" "),d=null,e=0;e<a.length;e++)-1<b.inArray(a[e],c)&&(d=a[e].replace("col",""));return d},saveBuilder:function(a,c,d){d=d||"main";var f=_.map(e.Instances.Builder,function(a,b){var c=a.$el.data("postid")||null,d=a.toJSON()||null;return{id:c,data:d}});console.log(f,"ids");return b.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tfb_save_data",tfb_load_nonce:themifyBuilder.tfb_load_nonce,ids:JSON.stringify(f),tfb_saveto:d},cache:!1,beforeSend:function(b){a&&ThemifyBuilderCommon.showLoader("show")},
success:function(d){a&&ThemifyBuilderCommon.showLoader("hide");b.isFunction(c)&&c.call(this,d);e.editing=!1;b("body").trigger("themify_builder_save_data")},error:function(){a&&ThemifyBuilderCommon.showLoader("error")}})},loadContentJs:function(a){"undefined"!==typeof ThemifyBuilderModuleJs&&ThemifyBuilderModuleJs.loadOnAjax(a);b("body").trigger("builder_load_on_ajax")},setupTooltips:function(){(function(){b("body").on("mouseover mouseout",'[rel^="themify-tooltip-"]',function(a){"mouseover"===a.type?
(a=b(this).data("title")?b(this).data("title"):b(this).prop("title"),b(this).append('<span class="themify_tooltip">'+a+"</span>")):b(this).children(".themify_tooltip").remove()})})();ThemifyBuilderCommon.setUpTooltip()},mediaUploader:function(){var a=b("body");a.on("click",".themify-builder-media-uploader",function(a){var c=b(this),e=c.closest(".themify_builder_input"),g=1===e.children("#background_image").length,e=1===e.children("#background_video").length,h=wp.media.frames.file_frame=wp.media({title:c.data("uploader-title"),
