...
(function(a){a("body").on("click",".module-audio .track-title",function(){a(this).closest(".track").find(".mejs-playpause-button").click();return!1}).on("builder_load_module_partial builder_toggle_frontend",function(){a(".module-audio audio").mediaelementplayer()})})(jQuery);
